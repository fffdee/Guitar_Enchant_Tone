...
/* 开启后下一帧 run_block 打印 block0/frame0 的 logmel/mask/gain_lin[0:8] */
void bnn_masknet_set_debug(bnn_masknet_t *m, int on);
...
/* 性能优化: 在建图后调用, 标记 fuse_relu 和预取权重。
 * 由 bnn_perf.h 宏控制, 无优化时为空操作。 */
